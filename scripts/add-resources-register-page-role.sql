-- Ensure 'resources_register' is in user_page_roles.page_id CHECK. Run after resources-register-schema.
-- IN list must match scripts/sync-user-page-roles-check-constraint.sql.
