        ...
        <header className="sticky top-0 z-30 flex h-14 shrink-0 items-center gap-3 border-b border-surface-200 bg-white/95 backdrop-blur px-4 lg:px-6">
          ...
          <div className="flex items-center gap-2 shrink-0">
            <button
              ...
              className="flex h-9 w-9 items-center justify-center rounded-lg border border-surface-200 bg-white text-surface-600 hover:bg-surface-50 transition-colors"
